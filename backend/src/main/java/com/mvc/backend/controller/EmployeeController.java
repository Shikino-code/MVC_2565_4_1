...
public class EmployeeController {
    ...
    @PostMapping("/calculateEmployee")
    public String calculateEmployee(@ModelAttribute("employee") Employee employee) throws ParseException {
        employeeService.calculateEmployee(employee);
        return "redirect:/";
    }
